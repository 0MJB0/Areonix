...
import 'create_diet_dietician_mixin.dart';

mixin CreateDietDieticianUIMixin<T extends ConsumerStatefulWidget>
    on ConsumerState<T>, CreateDietDieticianMixin<T> {
  // Ortak AppBar
  CommonAppbar appBar(BuildContext context) {
    return const CommonAppbar(
      title: StringConstants.createDietDieticianTitle,
    );
  }
  ...
  Widget chooseDayDropdown(BuildContext context) {
    return Padding(
      ...
      child: DropdownButtonChooseDay(
        width: kIsWeb
            ? Responsiveness.createDietChooseDayDropdownWeb
            : Responsiveness.createDietChooseDayDropdownMobile,
    ...
    return Container(
      ...
      child: ElevatedButton(
        ...
        child: kIsWeb
            ...
            : const BoldText(text: StringConstants.createDietDieticianSendDiet),
      ),
    );
  }
    ...
    return Expanded(
      child: SingleChildScrollView(
        child: Center(
          child: SizedBox(
            width: kIsWeb
                ? Responsiveness.createDietCardWeb.w
                : Responsiveness.createDietCardMobile.w,
            child: Column(
